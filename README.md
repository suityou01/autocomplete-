...
itemtemplate|The html template to use for autocomplete items||`<ac-input url='https://restcountries.eu/rest/v2/name/' itemtemplate="<div class='resultItem' id='${id}'><i>${name}</i></div>"></ac-input>`
